...
return(
    <>
        ...
        <div className="services">
            <div className='first'>
            <img style={{height: '300px', width: '400px', marginLeft: "20%"}} src={services1} alt="your-feelings-matter" />
            ...
            <div className='first'>
            <img style={{height: '300px', width: '400px', marginLeft: "20%"}} src={services2} alt="therapy-in-session" />
            <div className='anxiety-info'>
            ...
            <div className='first'>
            <img style={{height: '300px', width: '400px', marginLeft: "20%"}} src={services3} alt="children" />
            <div className='anxiety-info'>
            ...
            <div className='first'>
            <img style={{height: '300px', width: '400px', marginLeft: "20%"}} src={services4} alt="surgical-recovery" />
            <div className='anxiety-info'>
